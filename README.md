...
> A2A agent integration for Matrix messaging platform.
...
A2A (Agent-to-Agent) integration for Matrix. Part of the OpenSIN-AI ecosystem.
...
This agent connects to the OpenSIN orchestrator via A2A protocol and handles Matrix messaging operations.
